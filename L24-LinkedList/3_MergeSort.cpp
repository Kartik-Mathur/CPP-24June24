...
node* mergeSort(node* head) {
	...
	// 2. Sort divided linkedLists
	a = mergeSort(a); // Assumption recursion will sort the smaller linkedList
	b = mergeSort(b); // Assumption recursion will sort the smaller linkedList
